            ...
            <main className="d-flex flex-column w-100" id="main">
                ...
                <div className="main" id="main-top">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <span className="span-fecha">Inicio de sesión {startDate.getDate()<10?`0${startDate.getDate()}`:startDate.getDate()}-{(startDate.getMonth()+1)<10?`0${startDate.getMonth()+1}`:startDate.getMonth()+1}-{startDate.getFullYear()} a las {startDate.getHours()}:{startDate.getMinutes()}:{startDate.getSeconds()}</span>
                    </div>
